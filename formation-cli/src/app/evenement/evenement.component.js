...
var EvenementComponent = /** @class */ (function () {
    ...
    EvenementComponent.prototype.handleClick = function () {
        console.log('Le boutton a été cliqué');
    };
    EvenementComponent.prototype.clickButton = function () {
        this.isHidden = !this.isHidden;
    };
    EvenementComponent.prototype.mouseOver = function () {
        console.log('mouseover');
    };
    EvenementComponent.prototype.mouseOut = function () {
