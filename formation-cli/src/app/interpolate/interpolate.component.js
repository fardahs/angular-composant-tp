...
var InterpolateComponent = /** @class */ (function () {
    function InterpolateComponent() {
        this.nom = 'Bewizyu';
        this.prenom = 'Farda';
        this.formationAngular = 'Module angular';
        this.formation = new Formation_1.Formation('Module Angular');
    }
    InterpolateComponent.prototype.getTitle = function () {
    ...
    InterpolateComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () {
            _this.formationJS = new Formation_1.Formation('Module Angular');
        }, 3000);
    };
